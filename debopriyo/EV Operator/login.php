...
<head>
    ...
    <title>LOGIN | Charging Station</title>
...
<body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">Charging Station</h3>
   ...
   <iframe src="https://www.google.com/maps/d/embed?mid=1cUVjbGVd1gaPbquH_w47nPR99ZrrDpG7&ehbc=2E312F" width="640" height="480"></iframe>
</body>
<script>
    $(function(){
